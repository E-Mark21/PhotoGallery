...
public class PhotoGalleryFragment extends VisibleFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoRecyclerView = (RecyclerView) v.findViewById(R.id.photo_gallery_view);
    ...
    private class PhotoHolder extends RecyclerView.ViewHolder
        ...
        public PhotoHolder(View viewItem) {
            super(viewItem);
            mItemImageView = (ImageView) viewItem.findViewById(R.id.item_image_view);
