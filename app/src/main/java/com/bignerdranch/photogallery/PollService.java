...
public class PollService extends IntentService {
    ...
    public static final String PERM_PRIVATE = "com.binerdranch.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(Intent intent) {
        if (!isNetworkingAvailableAndConnected()) {
            return;
        }
    ...
    private boolean isNetworkingAvailableAndConnected() {
